...
namespace CustomerLibraryTests
{
    public class CustomerValidatorTests
    {
        ...
        public void shouldReturnErrorMessages()
        {
            ...
            ValidationResult results1 = customerValidator.Validate(customer);
            ...
            //Assert.Equal("Minimum length is 1 item", errorList1.FirstOrDefault(x => x.Item1 == "AdressesList").Item2);
            //Assert.Equal("Phone Number should have E.164 standart", errorList1.FirstOrDefault(x => x.Item1 == "PhoneNumber").Item2);
            //Assert.Equal("Email adress should be valid", errorList1.FirstOrDefault(x => x.Item1 == "Email").Item2);
            //Assert.Equal("Minimum length is 1 item", errorList1.FirstOrDefault(x => x.Item1 == "Note").Item2);
